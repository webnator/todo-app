...
export default class APIResponse {
  ...
  public constructor(response: Response, request: ServerRequest, extra: ExtraParams = {}) {
  ...
  public get mimeType(): MimeTypes {
    // const mimeTypes = this.request?.swagger?.operation?.produces || []; // TODO review this
    const mimeTypes = [];
    const requiredContent = this.forcedType || this.request?.headers?.accept as MimeTypes;
